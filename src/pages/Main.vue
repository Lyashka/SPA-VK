<template>
  <div class="main-container">
    ...
    <my-sign-in-vue v-model:show="signInWindowVisible">
          ...
          <div class="signIn_container"><a class="text_content"  href="https://oauth.vk.com/authorize?client_id=51428350&display=popup&redirect_uri=http://localhost:8080/SPA-VK/&scope=friends&response_type=token&v=v=5.131"><my-button class="signInBtn" @click="showWindowHide">Войти</my-button></a></div>
    </my-sign-in-vue>
